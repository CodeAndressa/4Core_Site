          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <ul className="flex flex-col gap-4">
              {[
                ...
                { label: 'Área administrativa', href: '/admin/login' },
              ].map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
              ...
              {[
                ...
                <div key={i} className="flex gap-4 group">
                  ...
                  <div>
                    ...
                    {item.href ? (
                      <a href={item.href} className="text-white/80 font-medium text-sm lg:text-base hover:text-white transition-colors">
                        {item.text}
                      </a>
                    ) : (
